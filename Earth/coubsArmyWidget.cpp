...
{
    texture.reset(new QOpenGLTexture(QImage("D:\\source\\repos\\Qt\\Earth\\Earth\\Earth_Albedo.jpg")));
    texture->setMinificationFilter(QOpenGLTexture::Nearest);
    texture->setMagnificationFilter(QOpenGLTexture::Linear);
    texture->setWrapMode(QOpenGLTexture::Repeat);

    normalMap.reset(new QOpenGLTexture(QImage("D:\\source\\repos\\Qt\\Earth\\Earth\\Earth_NormalMap.jpg")));
}
...
void CoubsArmy::initProgram()
{
    ...
    m_program->addShaderFromSourceFile(QOpenGLShader::Vertex, "D:\\source\\repos\\Qt\\Earth\\Earth\\vertexShaider.glsl");
    m_program->addShaderFromSourceFile(QOpenGLShader::Fragment, "D:\\source\\repos\\Qt\\Earth\\Earth\\fragmentShaider.glsl");
    m_program->link();
    m_program->bind();
}
