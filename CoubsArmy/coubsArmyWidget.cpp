...
void CoubsArmy::initProgram()
{
    ...
    m_program->addShaderFromSourceFile(QOpenGLShader::Vertex, "D:\\source\\repos\\Qt\\CoubsArmy\\vertexShaider.glsl");
    m_program->addShaderFromSourceFile(QOpenGLShader::Fragment, "D:\\source\\repos\\Qt\\CoubsArmy\\fragmentShaider.glsl");
    m_program->link();
    m_program->bind();
}
